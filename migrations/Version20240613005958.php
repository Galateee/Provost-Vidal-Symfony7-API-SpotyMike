 ...
 */
final class Version20240613005958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, id_user VARCHAR(90) NOT NULL, firstname VARCHAR(55) NOT NULL, lastname VARCHAR(55) NOT NULL, sexe VARCHAR(55) DEFAULT NULL, date_birth DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', email VARCHAR(80) NOT NULL, tel VARCHAR(15) DEFAULT NULL, password VARCHAR(90) NOT NULL, nb_try INT DEFAULT NULL, is_active TINYINT(1) NOT NULL, last_try_timestamp DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', create_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', update_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_8D93D6496B3CA4B (id_user), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
